...
<p align="center">
  <img
    src="https://i.pinimg.com/1200x/8b/3b/55/8b3b555a6af07df0228679e2b09a5c3c.jpg"
    width="100%"
    alt="img"
  />
</p>
...
Backend-разработчик, специализирующийся на проектировании и развитии веб-систем.

Разрабатываю бизнес-логику, REST API и интеграции, работаю с реляционными базами данных, очередями, кешированием и фоновыми процессами. Умею быстро погружаться в существующие кодовые базы, находить архитектурные и технические проблемы, проводить рефакторинг legacy-кода без нарушения текущих бизнес-процессов.

Принимаю технические решения с учётом производительности, безопасности, отказоустойчивости и дальнейшего масштабирования системы. Стремлюсь создавать предсказуемый и поддерживаемый код, который можно безопасно развивать вместе с продуктом.

---

## 🚀 Чем занимаюсь

- Проектирую архитектуру backend-приложений и структуру бизнес-логики
- Разрабатываю и документирую REST API для web- и мобильных приложений
- Декомпозирую сложные бизнес-процессы на независимые и поддерживаемые компоненты
- Проектирую базы данных, связи, индексы и транзакционные операции
- Оптимизирую SQL-запросы, загрузку данных и производительность приложения
- Реализую авторизацию, управление доступом, сессиями и безопасностью данных
- Интегрирую платёжные, почтовые, Telegram- и другие внешние сервисы
- Разрабатываю очереди, фоновые задачи, уведомления и WebSocket-механизмы
- Провожу рефакторинг legacy-кода и поэтапно улучшаю архитектуру без остановки продукта
- Настраиваю локальное окружение и контейнеризацию проектов через Docker
- Участвую в техническом проектировании, оценке задач и выборе решений
- Интегрирую backend с клиентскими приложениями на React и Next.js
